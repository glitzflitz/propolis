...
pub mod formats {
    ...
    impl Fadt {
        pub fn new() -> Self {
            ...
            data[FADT_OFF_PM1A_EVT_BLK
                ..FADT_OFF_PM1A_EVT_BLK + size_of::<u32>()]
                .copy_from_slice(&PIIX4_PM_BASE.to_le_bytes());
            data[FADT_OFF_PM1A_CNT_BLK
                ..FADT_OFF_PM1A_CNT_BLK + size_of::<u32>()]
                .copy_from_slice(
                    &(PIIX4_PM_BASE + PIIX4_PM1A_CNT_OFF).to_le_bytes(),
                );
            data[FADT_OFF_PM_TMR_BLK..FADT_OFF_PM_TMR_BLK + size_of::<u32>()]
                .copy_from_slice(
                    &(PIIX4_PM_BASE + PIIX4_PM_TMR_OFF).to_le_bytes(),
                );
            ...
            data[FADT_OFF_X_PM1A_EVT_BLK + GAS_OFF_SPACE_ID] =
                GAS_SPACE_SYSTEM_IO;
            data[FADT_OFF_X_PM1A_EVT_BLK + GAS_OFF_BIT_WIDTH] =
                PIIX4_PM1_EVT_LEN * 8;
            data[FADT_OFF_X_PM1A_EVT_BLK + GAS_OFF_ACCESS_WIDTH] =
                GAS_ACCESS_DWORD;
            ...
            data[FADT_OFF_X_PM1A_CNT_BLK + GAS_OFF_SPACE_ID] =
                GAS_SPACE_SYSTEM_IO;
            data[FADT_OFF_X_PM1A_CNT_BLK + GAS_OFF_BIT_WIDTH] =
                PIIX4_PM1_CNT_LEN * 8;
            data[FADT_OFF_X_PM1A_CNT_BLK + GAS_OFF_ACCESS_WIDTH] =
                GAS_ACCESS_WORD;
            data[FADT_OFF_X_PM1A_CNT_BLK + GAS_OFF_ADDRESS
                ..FADT_OFF_X_PM1A_CNT_BLK + GAS_OFF_ADDRESS + GAS_ADDRESS_LEN]
                .copy_from_slice(
                    &((PIIX4_PM_BASE + PIIX4_PM1A_CNT_OFF) as u64)
                        .to_le_bytes(),
                );

            data[FADT_OFF_X_PM_TMR_BLK + GAS_OFF_SPACE_ID] =
                GAS_SPACE_SYSTEM_IO;
            data[FADT_OFF_X_PM_TMR_BLK + GAS_OFF_BIT_WIDTH] =
                PIIX4_PM_TMR_LEN * 8;
            data[FADT_OFF_X_PM_TMR_BLK + GAS_OFF_ACCESS_WIDTH] =
                GAS_ACCESS_DWORD;
    ...
    impl Rsdp {
        pub fn new() -> Self {
            ...
            data[RSDP_SIGNATURE_OFFSET
                ..RSDP_SIGNATURE_OFFSET + RSDP_SIGNATURE_LEN]
